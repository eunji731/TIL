...
### (ResponseEntity의 내용물을 통일하는 공통 응답 객체)
...
❗ API마다 처리 코드를 따로 만들어야 하고

❗ 유지보수가 매우 힘들어진다.

ApiResponse를 쓰면

✅ **모든 API 응답 모양이 항상 같아진다.**
...
**이 요청이 성공했는지 실패했는지를 한 번 더 알려주는 표시**다.
